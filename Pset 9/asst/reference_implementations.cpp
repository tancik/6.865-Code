    ...
    int maxiDiam )
{
    ...
    // save_image(luminance, "Output/luminance.png");

    // blur
    Image<float> blurred_luminance = gaussian_blur(luminance, sigmaG, truncate);
    // save_image(blurred_luminance, "Output/blur_luminance.png");
    ...
    // save_image(normX, "Output/gradientX.png");
    // save_image(normY, "Output/gradientY.png");
    ...
    // save_image(norm_resp, "Output/response.png");
